...
<div class="row">
  <div class="col-xs-12 col-sm-6 col-md-6">
	<div class="img-detail" >
	  <a data-fancybox="gallery" href="media/5.jpeg"><img src="media/5.jpeg"></a>
	</div>
  </div>
  <div class="col-xs-12 col-sm-6 col-md-6">
		<h2>Judul foto</h2>
		...
		<div id="comment">
				<form name="submitcomment" method="post" action="submit/submit5.php">
			...
			<div id="publishcomment">
				...
				function getcomment($id){
					$commentquery = mysql_query("SELECT * FROM tabel WHERE caption=5 ORDER BY id DESC") or die(mysql_error());
